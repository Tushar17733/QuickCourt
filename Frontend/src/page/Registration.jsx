  ...
  return (
    <div className="min-h-screen bg-white font-sans text-gray-800">
      ...
      <div className="flex flex-col md:flex-row min-h-screen">
        ...
        <div className="relative flex flex-col w-full md:w-3/5 p-8 sm:p-12 md:p-16 justify-center min-h-screen md:min-h-0">
          <div className="flex flex-col items-center mt-16 md:mt-0 mb-8">
            <h2 className="text-4xl font-bold text-center mb-2">QUICKCOURT</h2>
